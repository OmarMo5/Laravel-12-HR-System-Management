...
<body
        ...
        <div
            ...
            <div
                ...
                <a href="{{ route('home') }}"
                    ...
                    <span class="hidden group-data-[sidebar-size=sm]:block">
                        <img src="{{ URL::to('assets/images/logo-dark.png') }}" alt="" class="h-10 mx-auto">
                    </span>
                    <span class="group-data-[sidebar-size=sm]:hidden">
                        <img src="{{ URL::to('assets/images/logo-light.png') }}" alt="" class="h-10 mx-auto">
                    </span>
                </a> --}}
                        ...
                        <div class="flex gap-3 ms-auto">
                            ...
                            <!-- <div class="relative flex items-center dropdown h-header">
                                ...
                                <div class="absolute z-50 hidden ltr:text-left rtl:text-right bg-white rounded-md shadow-md !top-4 dropdown-menu min-w-[20rem] lg:min-w-[26rem] dark:bg-zink-600"
                                    ...
                                    <div class="p-4">
                                        <h6 class="mb-4 text-16">{{ __('messages.notifications') }} <span
                                        ...
                                        <div class="flex flex-col gap-1" id="notification-list">
                                            <a href="#!"
                                                ...
                                                <div class="w-10 h-10 rounded-md shrink-0 bg-slate-100">
                                                    <img src="{{ URL::to('assets/images/avatar-3.png') }}"
                                            ...
                                            <a href="#!"
                                                ...
                                                <div class="w-10 h-10 bg-yellow-100 rounded-md shrink-0">
                                                    <img src="{{ URL::to('assets/images/avatar-5.png') }}"
                                                        alt="" class="rounded-md">
                                                </div>
                                                <div class="grow">
                                            ...
                                            <a href="#!"
                                                ...
                                                <div class="relative shrink-0">
                                                    <div class="w-10 h-10 bg-pink-100 rounded-md">
                                                        <img src="{{ URL::to('assets/images/avatar-7.png') }}"
                                                            alt="" class="rounded-md">
                                                    </div>
                                                    <div
                            ...
                            @include('HR.Attendance.partials.global-clock-button')
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a class="block ltr:pr-4 rtl:pl-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:text-custom-500 focus:text-custom-500 dark:text-zink-200 dark:hover:text-custom-500 dark:focus:text-custom-500"
                                                ...
                                                {{ __('messages.upgrade') }}
                                                <span
                                                    class="inline-flex items-center justify-center w-auto h-5 ltr:ml-2 rtl:mr-2 px-1 text-[12px] font-medium border rounded text-white bg-sky-500 border-sky-500">{{ __('messages.pro') }}</span>
                                            </a>
                                        </li>
                    ...
                    <div
                        ...
                        <div class="hidden lg:block">
                            <div class="ltr:text-right rtl:text-left">
                                {{ __('messages.design_develop_by') }} OmarMokhtar.dev </div>
                        </div>
                    </div>
                </div>
            </footer> -->
    ...
    <div id="customizerButton" drawer-end=""
        ...
        <div class="flex justify-between p-4 border-b border-slate-200 dark:border-zink-500">
            <div class="grow">
                <h5 class="mb-1 text-16">{{ __('messages.theme_customizer') }}</h5>
                <p class="font-normal text-slate-500 dark:text-zink-200">{{ __('messages.choose_themes') }}</p>
            </div>
            <div class="shrink-0">
        ...
        <div class="h-full p-6 overflow-y-auto">
            <div>
                <h5 class="mb-3 underline capitalize text-15">{{ __('messages.choose_layouts') }}</h5>
                <div class="grid grid-cols-1 mb-5 gap-7 sm:grid-cols-2">
                    <div class="relative">
                        ...
                        <h5 class="mt-2 text-center text-15">{{ __('messages.vertical') }}</h5>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <h5 class="mt-2 text-center text-15">{{ __('messages.horizontal') }}</h5>
                    </div>
                </div>
                ...
                <div id="semi-dark">
                    <div class="flex items-center">
                        ...
                        <label for="customDefaultSwitch"
                            class="inline-block text-base font-medium">{{ __('messages.semi_dark') }}</label>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-6">
                <!-- data-skin="" -->
                <h5 class="mb-3 underline capitalize text-15">{{ __('messages.skin_layouts') }}</h5>
                <div class="grid grid-cols-1 mb-5 gap-7 sm:grid-cols-2">
                    <div class="relative">
                        ...
                        <h5 class="mt-2 text-center text-15">{{ __('messages.default') }}</h5>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <h5 class="mt-2 text-center text-15">{{ __('messages.bordered') }}</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-6">
                <!-- dir="ltr" -->
                <h5 class="mb-3 underline capitalize text-15">{{ __('messages.ltr_rtl') }}</h5>
                <div class="flex flex-wrap gap-3">
                    <button type="button" id="diractionOne" name="dir" value="ltr"
                        class="transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-custom-500 [&.active]:bg-custom-50 [&.active]:border-custom-200 dark:bg-zink-600 dark:text-zink-200 dark:border-zink-400 dark:hover:bg-zink-600 dark:hover:text-zink-100 dark:hover:border-zink-400 dark:[&.active]:bg-custom-500/10 dark:[&.active]:border-custom-500/30 dark:[&.active]:text-custom-500 active">{{ __('messages.ltr_mode') }}
                    </button>
                    <button type="button" id="diractionTwo" name="dir" value="rtl"
                        class="transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-custom-500 [&.active]:bg-custom-50 [&.active]:border-custom-200 dark:bg-zink-600 dark:text-zink-200 dark:border-zink-400 dark:hover:bg-zink-600 dark:hover:text-zink-100 dark:hover:border-zink-400 dark:[&.active]:bg-custom-500/10 dark:[&.active]:border-custom-500/30 dark:[&.active]:text-custom-500">{{ __('messages.rtl_mode') }}
                    </button>
                </div>
            </div>
            ...
            <div class="mt-6">
                <!-- data-content -->
                <h5 class="mb-3 underline capitalize text-15">{{ __('messages.content_width') }}</h5>
                <div class="flex gap-3">
                    <button type="button" id="datawidthOne" name="datawidth" value="fluid"
                        class="transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-custom-500 [&.active]:bg-custom-50 [&.active]:border-custom-200 dark:bg-zink-600 dark:text-zink-200 dark:border-zink-400 dark:hover:bg-zink-600 dark:hover:text-zink-100 dark:hover:border-zink-400 dark:[&.active]:bg-custom-500/10 dark:[&.active]:border-custom-500/30 dark:[&.active]:text-custom-500 active">{{ __('messages.fluid') }}</button>
                    <button type="button" id="datawidthTwo" name="datawidth" value="boxed"
                        class="transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-custom-500 [&.active]:bg-custom-50 [&.active]:border-custom-200 dark:bg-zink-600 dark:text-zink-200 dark:border-zink-400 dark:hover:bg-zink-600 dark:hover:text-zink-100 dark:hover:border-zink-400 dark:[&.active]:bg-custom-500/10 dark:[&.active]:border-custom-500/30 dark:[&.active]:text-custom-500">{{ __('messages.boxed') }}</button>
                </div>
            </div>

            <div class="mt-6" id="sidebar-size">
                <!-- data-sidebar-size="" -->
                <h5 class="mb-3 underline capitalize text-15">{{ __('messages.sidebar_size') }}</h5>
                <div class="flex flex-wrap gap-3">
                    <button type="button" id="sidebarSizeOne" name="sidebarSize" value="lg"
                        class="transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-custom-500 [&.active]:bg-custom-50 [&.active]:border-custom-200 dark:bg-zink-600 dark:text-zink-200 dark:border-zink-400 dark:hover:bg-zink-600 dark:hover:text-zink-100 dark:hover:border-zink-400 dark:[&.active]:bg-custom-500/10 dark:[&.active]:border-custom-500/30 dark:[&.active]:text-custom-500 active">{{ __('messages.default') }}</button>
                    <button type="button" id="sidebarSizeTwo" name="sidebarSize" value="md"
                        class="transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-custom-500 [&.active]:bg-custom-50 [&.active]:border-custom-200 dark:bg-zink-600 dark:text-zink-200 dark:border-zink-400 dark:hover:bg-zink-600 dark:hover:text-zink-100 dark:hover:border-zink-400 dark:[&.active]:bg-custom-500/10 dark:[&.active]:border-custom-500/30 dark:[&.active]:text-custom-500">{{ __('messages.compact') }}</button>
                    <button type="button" id="sidebarSizeThree" name="sidebarSize" value="sm"
                        class="transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-custom-500 [&.active]:bg-custom-50 [&.active]:border-custom-200 dark:bg-zink-600 dark:text-zink-200 dark:border-zink-400 dark:hover:bg-zink-600 dark:hover:text-zink-100 dark:hover:border-zink-400 dark:[&.active]:bg-custom-500/10 dark:[&.active]:border-custom-500/30 dark:[&.active]:text-custom-500">{{ __('messages.small_icon') }}
                    </button>
                </div>
            </div>
            ...
            <div class="mt-6" id="navigation-type">
                <!-- data-navbar="" -->
                <h5 class="mb-3 underline capitalize text-15">{{ __('messages.navigation_type') }}</h5>
                <div class="flex flex-wrap gap-3">
                    <button type="button" id="navbarTwo" name="navbar" value="sticky"
                        class="transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-custom-500 [&.active]:bg-custom-50 [&.active]:border-custom-200 dark:bg-zink-600 dark:text-zink-200 dark:border-zink-400 dark:hover:bg-zink-600 dark:hover:text-zink-100 dark:hover:border-zink-400 dark:[&.active]:bg-custom-500/10 dark:[&.active]:border-custom-500/30 dark:[&.active]:text-custom-500 active">{{ __('messages.sticky') }}</button>
                    <button type="button" id="navbarOne" name="navbar" value="scroll"
                        class="transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-custom-500 [&.active]:bg-custom-50 [&.active]:border-custom-200 dark:bg-zink-600 dark:text-zink-200 dark:border-zink-400 dark:hover:bg-zink-600 dark:hover:text-zink-100 dark:hover:border-zink-400 dark:[&.active]:bg-custom-500/10 dark:[&.active]:border-custom-500/30 dark:[&.active]:text-custom-500">{{ __('messages.scroll') }}</button>
                    <button type="button" id="navbarThree" name="navbar" value="bordered"
                        class="transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-custom-500 [&.active]:bg-custom-50 [&.active]:border-custom-200 dark:bg-zink-600 dark:text-zink-200 dark:border-zink-400 dark:hover:bg-zink-600 dark:hover:text-zink-100 dark:hover:border-zink-400 dark:[&.active]:bg-custom-500/10 dark:[&.active]:border-custom-500/30 dark:[&.active]:text-custom-500">{{ __('messages.bordered') }}</button>
                    <button type="button" id="navbarFour" name="navbar" value="hidden"
                        class="transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-custom-500 [&.active]:bg-custom-50 [&.active]:border-custom-200 dark:bg-zink-600 dark:text-zink-200 dark:border-zink-400 dark:hover:bg-zink-600 dark:hover:text-zink-100 dark:hover:border-zink-400 dark:[&.active]:bg-custom-500/10 dark:[&.active]:border-custom-500/30 dark:[&.active]:text-custom-500">{{ __('messages.hidden') }}</button>
                </div>
            </div>

            <div class="mt-6" id="sidebar-color">
                <!-- data-sidebar="" light, dark, brand, modern-->
                <h5 class="mb-3 underline capitalize text-15">{{ __('messages.sidebar_colors') }}</h5>
                <div class="flex flex-wrap gap-3">
            ...
            <div class="mt-6">
                ...
                <h5 class="mb-3 underline capitalize text-15">{{ __('messages.topbar_colors') }}</h5>
                <div class="flex flex-wrap gap-3">
        ...
        <div class="flex items-center justify-between gap-3 p-4 border-t border-slate-200 dark:border-zink-500">
            <button type="button" id="reset-layout"
                class="w-full transition-all duration-200 ease-linear text-slate-500 btn bg-slate-200 border-slate-200 hover:text-slate-600 hover:bg-slate-300 hover:border-slate-300 focus:text-slate-600 focus:bg-slate-300 focus:border-slate-300 focus:ring focus:ring-slate-100">{{ __('messages.reset') }}</button>
            <a href="#!"
                class="w-full text-white transition-all duration-200 ease-linear bg-red-500 border-red-500 btn hover:text-white hover:bg-red-600 hover:border-red-600 focus:text-white focus:bg-red-600 focus:border-red-600 focus:ring focus:ring-red-100 active:text-white active:bg-red-600 active:border-red-600 active:ring active:ring-red-100">{{ __('messages.buy_now') }}</a>
        </div>
    </div>
