...
@section('content')
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="card">
                <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($departmentList as $key => $value)
                                <tr>
                                    ...
                                    <td class="department-name px-3.5 py-2.5 border border-slate-200 dark:border-zink-500">
                                        {{ $value->department }}</td>
                                    <td class="head-of-name px-3.5 py-2.5 border border-slate-200 dark:border-zink-500">
                                        {{ $value->head_of }}</td>
                                    <td class="phone-number px-3.5 py-2.5 border border-slate-200 dark:border-zink-500">
                                        {{ $value->phone_number }}</td>
                                    <td class="email-address px-3.5 py-2.5 border border-slate-200 dark:border-zink-500">
                                        {{ $value->email }}</td>
                                    <td class="total-employee px-3.5 py-2.5 border border-slate-200 dark:border-zink-500">
                                        {{ $value->total_employee }}</td>
                                    <td class="px-3.5 py-2.5 border border-slate-200 dark:border-zink-500">
                    ...
                    <div class="mt-4">
                        {{ $departmentList->appends(request()->query())->links() }}
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="addDepartmentModal" modal-center=""
        ...
        <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
            <div class="flex items-center justify-between p-4 border-b dark:border-zink-500">
                <h5 class="text-16">{{ __('messages.add_department') }}</h5>
                    ...
                    <div class="grid grid-cols-1 gap-4 xl:grid-cols-12">
                        <div class="xl:col-span-12">
                            <label for="departmentInput"
                                class="inline-block mb-2 text-base font-medium">{{ __('messages.department_name') }}</label>
                        ...
                        <div class="xl:col-span-12">
                            <label for="headOfInput"
                                class="inline-block mb-2 text-base font-medium">{{ __('messages.head_of_department') }}</label>
                            <input type="text" name="head_of" id="headOfInput"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 @error('head_of') is-invalid @enderror"
                                placeholder="{{ __('messages.enter_head_name') }}" value="{{ old('head_of') }}" required>
                            @error('head_of')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="xl:col-span-12">
                            <label for="employeeNumberInput"
                                class="inline-block mb-2 text-base font-medium">{{ __('messages.total_employee') }}</label>
                            <input type="number" name="total_employee" id="employeeNumberInput"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 @error('total_employee') is-invalid @enderror"
                                placeholder="{{ __('messages.enter_total_employee') }}"
                                value="{{ old('total_employee') }}" required>
    ...
    <div id="editDepartmentModal" modal-center=""
        ...
        <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
            <div class="flex items-center justify-between p-4 border-b dark:border-zink-500">
                <h5 class="text-16">{{ __('messages.edit_department') }}</h5>
                    ...
                    <div class="grid grid-cols-1 gap-4 xl:grid-cols-12">
                        ...
                        <div class="xl:col-span-12">
                            <label for="e_head_of_input"
                                class="inline-block mb-2 text-base font-medium">{{ __('messages.head_of_department') }}</label>
                            <input type="text" name="head_of" id="e_head_of_input"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                placeholder="{{ __('messages.enter_head_name') }}" required>
                        </div>
                        <div class="xl:col-span-12">
                        ...
                        <div class="xl:col-span-12">
                            <label for="e_total_employee_input"
                                class="inline-block mb-2 text-base font-medium">{{ __('messages.total_employee') }}</label>
                            <input type="number" name="total_employee" id="e_total_employee_input"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                placeholder="{{ __('messages.enter_total_employee') }}" required>
                        </div>
                    </div>
                    <div class="flex justify-end gap-2 mt-4">
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            // Update record - using class instead of id
            $(document).on('click', '.update-record-btn', function() {
                ...
                var totalEmployee = _this.find('.total-employee').text().trim();
                ...
                $('#e_total_employee_input').val(totalEmployee);
