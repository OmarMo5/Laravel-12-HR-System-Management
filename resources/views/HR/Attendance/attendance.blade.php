...
@section('content')
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                ...
                <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
                    ...
                    <li class="text-slate-700 dark:text-zink-100">
                        {{ __('messages.attendance_management') }}
                    </li>
                </ul>
            </div>
                ...
                <div class="lg:col-span-12 xl:col-span-3 xl:row-span-2">
                    ...
                    <div class="mb-5">
                        <label for="employeeSelect"
                            class="inline-block mb-2 text-base font-medium">{{ __('messages.select_employee') }}</label>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td
                                                    ...
                                                    {{ __('messages.employee_id') }}</td>
                                                <td
                                                    class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent font-semibold">
                                                    {{ $selectedUser->user_id }}</td>
                                            </tr>
                                            <tr>
                                                <td
                                                    class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent text-slate-500 dark:text-zink-200">
                                                    {{ __('messages.department') }}</td>
                                                <td
                                                    class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent font-semibold">
                                                    {{ $selectedUser->department ?? '—' }}</td>
                                            </tr>
                                            <tr>
                                                <td
                                                    class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent text-slate-500 dark:text-zink-200">
                                                    {{ __('messages.experience') }}</td>
                                                <td
                                                    class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent font-semibold">
                                                    {{ $selectedUser->experience ?? '—' }}</td>
                                            </tr>
                                            <tr>
                                                <td
                                                    class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent text-slate-500 dark:text-zink-200">
                                                    {{ __('messages.joining_date') }}</td>
                                                <td
                                                    class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent font-semibold">
                                            ...
                                            <tr>
                                                <td
                                                    class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent text-slate-500 dark:text-zink-200">
                                                    {{ __('messages.present_days') }}</td>
                                                <td
                                                    class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent font-semibold">
                                                    {{ $stats['present_days'] ?? 0 }}</td>
                                            </tr>
                                            <tr>
                                                <td
                                                    class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent text-slate-500 dark:text-zink-200">
                                                    {{ __('messages.absent_days') }}</td>
                                                <td
                                                    class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent font-semibold">
                                                    {{ $stats['absent_days'] ?? 0 }}</td>
                                            </tr>
                                            <tr>
                                                <td
                                                    class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent text-slate-500 dark:text-zink-200">
                                                    {{ __('messages.late_days') }}</td>
                                                <td
                                                    class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent font-semibold">
                                                    {{ $stats['late_days'] ?? 0 }}</td>
                                            </tr>
                                            <tr>
                                                <td
                                                    class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent text-slate-500 dark:text-zink-200">
                                                    {{ __('messages.early_departures') }}</td>
                                                <td
                                                    class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent font-semibold">
                                                    {{ $stats['early_departure_days'] ?? 0 }}</td>
                                            </tr>
                                            <tr>
                                                <td
                                                    class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent text-slate-500 dark:text-zink-200">
                                                    {{ __('messages.total_hours') }}</td>
                                                <td
                                                    class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent font-semibold">
                                            ...
                                            <tr>
                                                <td
                                                    class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent text-slate-500 dark:text-zink-200">
                                                    {{ __('messages.regular_hours') }}</td>
                                                <td
                                                    class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent font-semibold">
                                                    {{ number_format($stats['regular_hours'] ?? 0, 1) }}
                                                    {{ __('messages.hrs') }}</td>
                                            </tr>
                                            <tr>
                                                <td
                                                    class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent text-slate-500 dark:text-zink-200">
                                                    {{ __('messages.overtime') }}</td>
                                                <td
                                                    class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent font-semibold">
                                                    {{ number_format($stats['overtime_hours'] ?? 0, 1) }}
                                                    {{ __('messages.hrs') }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                            ...
                            <div class="grow">
                                <h5 class="mb-1 text-16">
                                    <span class="counter-value"
                                        data-target="{{ number_format($stats['approved_hours'] ?? 0, 1) }}">0</span>
                                </h5>
                    ...
                    <div class="card">
                        <div class="flex items-center gap-4 card-body">
                            ...
                            <div class="grow">
                                <h5 class="mb-1 text-16">
                                    <span class="counter-value"
                                        data-target="{{ number_format($stats['rejected_hours'] ?? 0, 1) }}">0</span>
                                </h5>
                    ...
                    <div class="card">
                        <div class="flex items-center gap-4 card-body">
                            ...
                            <div class="grow">
                                <h5 class="mb-1 text-16">
                                    <span class="counter-value"
                                        data-target="{{ number_format($stats['pending_hours'] ?? 0, 1) }}">0</span>
                                </h5>
                                ...
                                <div class="xl:col-span-3">
                                    <div class="relative">
                                        <input type="text" id="searchInput"
                                            ...
                                            placeholder="{{ __('messages.search_by_date') }}" autocomplete="off">
                                        <i data-lucide="search"
                                            class="inline-block size-4 absolute ltr:left-2.5 rtl:right-2.5 top-2.5 text-slate-500 dark:text-zink-200"></i>
                                    </div>
                                </div><!--end col-->
                                        ...
                                        <tr>
                                            <th
                                                ...
                                                <input type="checkbox" id="selectAll"
                                                    class="rounded border-slate-200 dark:border-zink-500">
                                            </th>
                                            <th
                                                class="px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500">
                                                {{ __('messages.date') }}</th>
                                            <th
                                                class="px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500">
                                                {{ __('messages.check_in') }}</th>
                                            <th
                                                class="px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500">
                                                {{ __('messages.check_out') }}</th>
                                            <th
                                                class="px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500">
                                                {{ __('messages.status') }}</th>
                                            <th
                                                class="px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500">
                                                {{ __('messages.work_hours') }}</th>
                                            <th
                                                class="px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500">
                                                {{ __('messages.overtime_short') }}</th>
                                            <th
                                                class="px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500">
                                                {{ __('messages.late_early') }}</th>
                                            <th
                                                class="px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500">
                                        ...
                                        @forelse($attendances as $attendance)
                                            <tr data-id="{{ $attendance->id }}">
                                                <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">
                                                    <input type="checkbox"
                                                        class="attendance-checkbox rounded border-slate-200 dark:border-zink-500"
                                                        value="{{ $attendance->id }}">
                                                </td>
                                                <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">
                                                ...
                                                <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">
                                                    @php
                                                        $statusColors = [
                                                            ...
                                                            'early_departure' =>
                                                                'bg-orange-100 text-orange-500 border-orange-100',
                                                    ...
                                                    @endphp
                                                    <span
                                                        class="px-2.5 py-0.5 inline-block text-xs font-medium rounded border {{ $statusColors[$attendance->status] ?? 'bg-slate-100 text-slate-500' }}">
                                                        {{ $statusText[$attendance->status] ?? ucfirst($attendance->status) }}
                                                    </span>
                                                </td>
                                                <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">
                                                    {{ number_format($attendance->working_hours, 2) }}
                                                    {{ __('messages.hrs') }}
                                                </td>
                                                <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">
                                                ...
                                                <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">
                                                    @if ($attendance->late_minutes > 0)
                                                        <span
                                                            class="text-yellow-600">{{ round($attendance->late_minutes) }}
                                                            {{ __('messages.min_late') }}</span>
                                                    @elseif($attendance->early_departure_minutes > 0)
                                                        <span
                                                            class="text-orange-600">{{ round($attendance->early_departure_minutes) }}
                                                            {{ __('messages.min_early') }}</span>
                                                    @else
                                                ...
                                                <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">
                                                    <div class="flex gap-2">
                                                        @if ($attendance->status != 'approved' && $attendance->status != 'rejected')
                                                            <button type="button"
    ...
    <div id="attendanceDetailModal" modal-center
        class="fixed flex flex-col hidden transition-all duration-300 -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2 w-full max-w-2xl max-h-fit bg-white rounded-lg dark:bg-zink-600 z-[9999]">
        ...
        <div class="flex justify-end p-4 border-t border-slate-200 dark:border-zink-500">
            <button type="button" data-modal-close="attendanceDetailModal"
                class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600">{{ __('messages.close') }}</button>
        </div>
    </div>
    ...
    @section('script')
        <script>
            ...
            // Load employee data via AJAX when selected
            $('#employeeSelect').on('change', function() {
                var userId = $(this).val();
                if (userId) {
                    $.ajax({
                        url: "{{ url('hr/attendance/get-employee-data') }}/" + userId,
                        type: 'GET',
            ...
            function updateEmployeeInfo(data) {
                ...
                var html = '<div class="card-body">' +
                    '<div class="text-center">' +
                    '<div class="mx-auto rounded-full size-20 bg-slate-100 dark:bg-zink-600">' +
                    '<img src="' + (data.user.avatar ? "{{ asset('assets/images/user') }}/" + data.user.avatar :
                        "{{ asset('assets/images/profile.png') }}") + '" alt="" class="h-20 rounded-full">' +
                    '</div>' +
                    '<h6 class="mt-3 mb-1 text-16"><a href="#!">' + (data.user.name ||
                        '{{ __('messages.no_employee_selected') }}') + '</a></h6>' +
                    '<p class="text-slate-500 dark:text-zink-200">' + (data.user.position || '—') + '</p>' +
                    '</div>' +
                    '<div class="mt-5 overflow-x-auto">' +
                    '<table class="w-full mb-0">' +
                    '<tbody>' +
                    '<tr><td class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent text-slate-500 dark:text-zink-200">{{ __('messages.employee_id') }}</td>' +
                    '<td class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent font-semibold">' + (data.user
                        .user_id || '—') + '</td></tr>' +
                    '<tr><td class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent text-slate-500 dark:text-zink-200">{{ __('messages.department') }}</td>' +
                    '<td class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent font-semibold">' + (data.user
                        .department || '—') + '</td></tr>' +
                    '<tr><td class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent text-slate-500 dark:text-zink-200">{{ __('messages.experience') }}</td>' +
                    '<td class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent font-semibold">' + (data.user
                        .experience || '—') + '</td></tr>' +
                    '<tr><td class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent text-slate-500 dark:text-zink-200">{{ __('messages.joining_date') }}</td>' +
                    '<td class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent font-semibold">' + (data.user
                        .join_date || '—') + '</td></tr>' +
                    '<tr><td class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent text-slate-500 dark:text-zink-200">{{ __('messages.present_days') }}</td>' +
                    '<td class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent font-semibold">' + (data.stats
                        .present_days || 0) + '</td></tr>' +
                    '<tr><td class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent text-slate-500 dark:text-zink-200">{{ __('messages.absent_days') }}</td>' +
                    '<td class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent font-semibold">' + (data.stats
                        .absent_days || 0) + '</td></tr>' +
                    '<tr><td class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent text-slate-500 dark:text-zink-200">{{ __('messages.late_days') }}</td>' +
                    '<td class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent font-semibold">' + (data.stats
                        .late_days || 0) + '</td></tr>' +
                    '<tr><td class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent text-slate-500 dark:text-zink-200">{{ __('messages.early_departures') }}</td>' +
                    '<td class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent font-semibold">' + (data.stats
                        .early_departure_days || 0) + '</td></tr>' +
                    '<tr><td class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent text-slate-500 dark:text-zink-200">{{ __('messages.total_hours') }}</td>' +
                    '<td class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent font-semibold">' + (data.stats
                        .total_hours || 0).toFixed(1) + ' {{ __('messages.hrs') }}</td></tr>' +
                    '<tr><td class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent text-slate-500 dark:text-zink-200">{{ __('messages.regular_hours') }}</td>' +
                    '<td class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent font-semibold">' + (data.stats
                        .regular_hours || 0).toFixed(1) + ' {{ __('messages.hrs') }}</td></tr>' +
                    '<tr><td class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent text-slate-500 dark:text-zink-200">{{ __('messages.overtime') }}</td>' +
                    '<td class="px-3.5 py-2.5 first:pl-0 last:pr-0 border-y border-transparent font-semibold">' + (data.stats
                        .overtime_hours || 0).toFixed(1) + ' {{ __('messages.hrs') }}</td></tr>' +
                    '</tbody></table></div></div>';
                        ...
                        $.ajax({
                            ...
                            error: function() {
                                Swal.fire('{{ __('messages.error') }}',
                                    '{{ __('messages.update_failed') }}', 'error');
                            }
                        });
                    }
                });
            ...
            $('#approveAllBtn').on('click', function() {
                ...
                if (selectedIds.length === 0) {
                    Swal.fire('{{ __('messages.warning') }}', '{{ __('messages.select_at_least_one') }}',
                        'warning');
                    return;
                }
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response.success) {
                                    Swal.fire('{{ __('messages.success') }}', response.message,
                                        'success').then(() => {
                                        location.reload();
                                    });
                                }
