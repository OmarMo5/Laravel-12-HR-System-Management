            ...
            <div class="grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-12">
                    ...
                    <div class="card">
                        <div class="flex items-center gap-4 card-body">
                            ...
                            <div class="overflow-hidden grow">
                                ...
                                <p class="truncate text-slate-500 dark:text-zink-200">{{ __('messages.total_employee') }}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="xl:col-span-3">
                    <div class="card">
                        <div class="flex items-center gap-4 card-body">
                            <div
                                class="flex items-center justify-center rounded-md size-12 text-custom-500 bg-custom-100 text-15 dark:bg-custom-500/20 shrink-0">
                        ...
                        <div class="xl:col-span-2 xl:col-start-11">
                            <div class="relative">
                                ...
                                <input type="text"
                                    ...
                                    readonly="readonly" placeholder="{{ __('messages.select_date') }}">
                            </div>
                        </div>
                    </div><!--end grid-->
                        ...
                        <table class="w-full whitespace-nowrap">
                            ...
                            <tbody>
                                <tr class="*:px-3.5 *:py-2.5 *:border-y *:border-slate-200 *:dark:border-zink-500">
                                    <td><a href="#!"
                                            class="transition-all duration-200 ease-linear">{{ __('messages.employee_name') }}
                                            1</a></td>
                                    <td><i data-lucide="x" class="text-red-500 size-4"
                                            title="{{ __('messages.absent') }}"></i></td>
                                    <td><i data-lucide="x" class="text-red-500 size-4"
                                            title="{{ __('messages.absent') }}"></i></td>
                                    <td>-</td>
                                    <td>-</td>
                                    <td><a href="#!" data-modal-target="addOrderModal"
                                            class="text-green-500 transition-all duration-200 ease-linear hover:text-green-600"
                                            title="{{ __('messages.present') }}"><i data-lucide="check"
                                                class="size-4"></i></a></td>
                                    <td><a href="#!" data-modal-target="addOrderModal"
                                            class="text-green-500 transition-all duration-200 ease-linear hover:text-green-600"
                                            title="{{ __('messages.present') }}"><i data-lucide="check"
                                ...
                                <!-- باقي الصفوف بنفس النمط - أضفت title لكل الأيقونات -->
                            </tbody>
                        </table>
                    </div>
                </div>
...
@section('script')
    <script>
        ...
        $(document).ready(function() {
            // Add title attributes to all check and x icons for better accessibility
            $('[data-lucide="check"]').parent('a').attr('title', '{{ __('messages.present') }}');
            $('[data-lucide="x"]').attr('title', '{{ __('messages.absent') }}');
        });
    </script>
@endsection
@endsection
