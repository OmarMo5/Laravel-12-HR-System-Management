...
@section('content')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="flex items-center">
                        <h6 class="text-15 grow">{{ __('messages.employee_list') }}</h6>
                        <div class="shrink-0">
                    ...
                    <table id="alternativePagination" class="display" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th hidden>Status</th>
                                <th class="ltr:!text-left rtl:!text-right">{{ __('messages.name') }}</th>
                        ...
                        <tbody>
                            @foreach ($employeeList as $key => $employee)
                                ...
                                <tr
                                    ...
                                    <td class="px-3.5 py-2.5 first:pl-5 last:pr-5"><a
                                            href="{{ url('page/account/' . $employee->user_id) }}"
                                            class="transition-all duration-150 ease-linear text-custom-500 hover:text-custom-600 user-id user_id">{{ $employee->user_id }}</a>
                                    </td>
                                    ...
                                    <td class="px-3.5 py-2.5 first:pl-5 last:pr-5">
                                        @if ($employee->status == 'Active')
                                            <span
                                                class="px-2.5 py-0.5 text-xs font-medium rounded border bg-green-100 border-transparent text-green-500 dark:bg-green-500/20 dark:border-transparent inline-flex items-center">
                                    ...
                                    <td class="Action">
                                        <div class="flex gap-3">
                                            <a class="flex items-center justify-center transition-all duration-200 ease-linear rounded-md size-8 bg-slate-100 text-slate-500 hover:text-custom-500 hover:bg-custom-100 dark:bg-zink-600 dark:text-zink-200 dark:hover:bg-custom-500/20 dark:hover:text-custom-500"
                                                href="pages-account.html"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    stroke-linejoin="round" data-lucide="eye"
                                                    class="lucide lucide-eye inline-block size-3">
                                                    <path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"></path>
                                                    <circle cx="12" cy="12" r="3"></circle>
                                                </svg> </a>
                                            <a data-modal-target="editEmployeeModal" id="editEmployee"
                                                class="flex items-center justify-center transition-all duration-200 ease-linear rounded-md size-8 text-slate-500 bg-slate-100 hover:text-white hover:bg-slate-500 dark:bg-zink-600 dark:text-zink-200 dark:hover:text-white dark:hover:bg-zink-500"><i
    ...
    <div id="addEmployeeModal" modal-center=""
        ...
        <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                <form class="create-form" id="create-form" action="{{ route('hr/employee/save') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    {{-- حقل user_id مخفي عشان نبعته مع الفورم --}}
                    ...
                    <div class="grid grid-cols-1 gap-4 xl:grid-cols-12">
                        <div class="xl:col-span-12">
                            <div
                                ...
                                <div
                                    ...
                                    {{-- غيرنا name من photo إلى avatar --}}
                        ...
                        <div class="xl:col-span-12">
                            ...
                            {{-- ده مجرد عرض، القيمة هتتبعت في الـ hidden field --}}
                        ...
                        <div class="xl:col-span-12">
                            <label for="emailInput"
                                class="inline-block mb-2 text-base font-medium">{{ __('messages.email') }}</label>
                        ...
                        <div class="xl:col-span-12">
                            <label for="positionInput"
                                class="inline-block mb-2 text-base font-medium">{{ __('messages.position') }}</label>
                            <select name="position"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                data-choices="" data-choices-search-false="" id="typeSelect">
                        ...
                        <div class="xl:col-span-12">
                            ...
                            <input type="text" name="department"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 @error('email') is-invalid @enderror "
                                placeholder="{{ __('messages.enter_department') }}" value="{{ old('department') }}">
                            @error('department')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="xl:col-span-6">
                            <label for="role_name"
                                class="inline-block mb-2 text-base font-medium">{{ __('messages.role_name') }}</label>
                        ...
                        <div class="xl:col-span-6">
                            <label for="status"
                                class="inline-block mb-2 text-base font-medium">{{ __('messages.status') }}</label>
                            <select name="status"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                data-choices="" data-choices-search-false="" id="typeSelect">
                        ...
                        <div class="xl:col-span-6">
                            <label for="locationInput"
                                class="inline-block mb-2 text-base font-medium">{{ __('messages.location') }}</label>
                        ...
                        <div class="xl:col-span-6">
                            ...
                            <input type="text" name="join_date" id="joiningDateInput"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 @error('join_date') is-invalid @enderror "
                        ...
                        <div class="xl:col-span-6">
                            ...
                            <input type="number" name="experience" id="experienceInput"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 @error('experience') is-invalid @enderror "
                    ...
                    <div class="flex justify-end gap-2 mt-4">
                        ...
                        <button type="submit" id="addNew"
                            class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20 addEmployeeModal">{{ __('messages.add') }}</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div id="editEmployeeModal" modal-center=""
        ...
        <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                <form class="create-form" id="create-form" action="{{ route('hr/employee/update') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    {{-- حقول مخفية --}}
                    ...
                    <div class="grid grid-cols-1 gap-4 xl:grid-cols-12">
                        ...
                        <div class="xl:col-span-12">
                            <label for="emailInput"
                                class="inline-block mb-2 text-base font-medium">{{ __('messages.email') }}</label>
                            <input type="text" name="email" id="e_email"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 @error('email') is-invalid @enderror "
                                placeholder="{{ __('messages.enter_email') }}" value="{{ old('email') }}">
                            @error('email')
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="xl:col-span-12">
                            ...
                            <select name="position" id="e_position"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                data-choices-search-false="" id="typeSelect">
                                <option value="">{{ __('messages.select_position') }}</option>
                                @foreach ($position as $key => $value)
                                    <option value="{{ $value->position }}">{{ $value->position }}</option>
                                @endforeach
                        ...
                        <div class="xl:col-span-12">
                            <label for="positionInput"
                                class="inline-block mb-2 text-base font-medium">{{ __('messages.department') }}</label>
                            <input type="text" name="department" id="e_department"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 @error('email') is-invalid @enderror "
                                placeholder="{{ __('messages.enter_department') }}" value="{{ old('department') }}">
                            @error('department')
                                <span class="invalid-feedback" role="alert">
                    ...
                    <div class="flex justify-end gap-2 mt-4">
                        <button type="reset" id="close-modal" data-modal-close="editEmployeeModal"
                            class="text-red-500 bg-white btn hover:text-red-500 hover:bg-red-100 focus:text-red-500 focus:bg-red-100 active:text-red-500 active:bg-red-100 dark:bg-zink-600 dark:hover:bg-red-500/10 dark:focus:bg-red-500/10 dark:active:bg-red-500/10">{{ __('messages.cancel') }}</button>
                        <button type="submit" id="addNew"
                            class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20 ">{{ __('messages.update') }}</button>
                    </div>
                </form>
            </div>
        </div>
...
@section('script')
    ...
    <script>
        $(document).on('click', '#editEmployee', function() {
            ...
            // Handle avatar
            var avatar = _this.find('.photo').text().trim();
            ...
            $('#e_department').val(_this.find('.department').text().trim());
            $('#e_role_name').val(_this.find('.role_name').text().trim());
            $('#e_status').val(_this.find('.statuss').text().trim());
        });
    </script>
    ...
    <script>
        $(document).on('click', '#deleteRecord', function() {
            var _this = $(this).closest('tr'); // use closest, not parents
            $('#e_idDelete').val(_this.find('.id').text().trim()); // class should be 'id' not 'ids'
            $('#del_avatar').val(_this.find('.photo').text().trim()); // name to del_avatar
        });
    </script>

    <script>
        // for add profile
        if (document.querySelector("#add-profile-img-file-input")) {
            document.querySelector("#add-profile-img-file-input").addEventListener("change", function() {
                var preview = document.querySelector("#add-user-profile-image");
        ...
        if (document.querySelector("#edit-profile-img-file-input")) {
            document.querySelector("#edit-profile-img-file-input").addEventListener("change", function() {
                var preview = document.querySelector("#e_avatar_edit");
                var file = this.files[0];
                var reader = new FileReader();
                reader.addEventListener("load", function() {
                    preview.src = reader.result;
